...
cc_data  = rodar_radon(["radon", "cc",  "./great_tables", "-j"])
print("Rodando radon mi...")
mi_data  = rodar_radon(["radon", "mi",  "./great_tables", "-j"])
print("Rodando radon hal...")
hal_data = rodar_radon(["radon", "hal", "./great_tables", "-j"])
print("Rodando radon raw...")
raw_data = rodar_radon(["radon", "raw", "./great_tables", "-j"])
